...
HRESULT WINAPI Empty_DwmEnableComposition				(UINT)
{
    return 0;
}
HRESULT WINAPI Empty_DwmSetDxFrameDuration				(HWND, INT)
{
    return 0;
}
HRESULT WINAPI Empty_DwmSetPresentParameters			(HWND, DWM_PRESENT_PARAMETERS *)
{
    return 0;
}
HRESULT WINAPI Empty_DwmExtendFrameIntoClientArea		(HWND, const MARGINS *)
{
    return 0;
}
HRESULT WINAPI Empty_DwmSetWindowAttribute				(HWND, DWORD, LPCVOID, DWORD )
{
    return 0;
}
HRESULT WINAPI Empty_DwmIsCompositionEnabled			(BOOL *)
{
    return 0;
}
