...
static unsigned int DbgFetchByte(unsigned int nAddress)
{
    return SekFetchByte(nAddress);
}
static unsigned int DbgFetchWord(unsigned int nAddress)
{
    return SekFetchWord(nAddress);
}
static unsigned int DbgFetchLong(unsigned int nAddress)
{
    return SekFetchLong(nAddress);
}
