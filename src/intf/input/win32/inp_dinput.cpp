...
int gamepadState(gamepadData *gamepad, unsigned int subCode)
{
    if (subCode < 0x10)  										// gamepad directions
    {
        ...
        {
        case 0x00:
            return gamepad->dijs.lX < -DEADZONE;		// Left
        case 0x01:
            return gamepad->dijs.lX > DEADZONE;		// Right
        case 0x02:
            return gamepad->dijs.lY < -DEADZONE;		// Up
        case 0x03:
            return gamepad->dijs.lY > DEADZONE;		// Down
        case 0x04:
            return gamepad->dijs.lZ < -DEADZONE;
        case 0x05:
            return gamepad->dijs.lZ > DEADZONE;
        case 0x06:
            return gamepad->dijs.lRx < -DEADZONE;
        case 0x07:
            return gamepad->dijs.lRx > DEADZONE;
        case 0x08:
            return gamepad->dijs.lRy < -DEADZONE;
        case 0x09:
            return gamepad->dijs.lRy > DEADZONE;
        case 0x0A:
            return gamepad->dijs.lRz < -DEADZONE;
        case 0x0B:
            return gamepad->dijs.lRz > DEADZONE;
        case 0x0C:
            return gamepad->dijs.rglSlider[0] < -DEADZONE;
        case 0x0D:
            return gamepad->dijs.rglSlider[0] > DEADZONE;
        case 0x0E:
            return gamepad->dijs.rglSlider[1] < -DEADZONE;
        case 0x0F:
            return gamepad->dijs.rglSlider[1] > DEADZONE;
        }
    }
