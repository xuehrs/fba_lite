...
unsigned int RGBtoYUV(unsigned int c)
{
    ...
    __asm
    {
        ...
        mov		eax, 0x000000FF
        movd	mm5, eax		;
        mm5 = REDMASK = 0x000000FF
        mov		eax, 0x0000FF00
        movd	mm6, eax		;
        mm6 = GREENMASK = 0x0000FF00
        mov		eax, 0x00FF0000
        movd	mm7, eax		;
        mm7 = BLUEMASK = 0x00FF0000
