...
HRESULT WINAPI Empty_DirectDrawCreateEx (GUID FAR *, LPVOID *, REFIID, IUnknown FAR *)
{
    return 0;
}
...
HRESULT WINAPI Empty_DirectDrawCreateClipper (DWORD, LPDIRECTDRAWCLIPPER FAR *, IUnknown FAR *)
{
    return 0;
}
...
HRESULT WINAPI Empty_DirectDrawEnumerateEx (LPDDENUMCALLBACKEXW, LPVOID, DWORD)
{
    return 0;
}
#else
HRESULT (WINAPI *_DirectDrawEnumerateEx) (LPDDENUMCALLBACKEXA, LPVOID, DWORD);
HRESULT WINAPI Empty_DirectDrawEnumerateEx (LPDDENUMCALLBACKEXA, LPVOID, DWORD)
{
    return 0;
}
#endif
