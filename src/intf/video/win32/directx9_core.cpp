...
LPDIRECT3D9 WINAPI Empty_Direct3DCreate9 (UINT)
{
    return NULL;
}
...
HRESULT WINAPI Empty_D3DXFillTextureTX (LPDIRECT3DTEXTURE9, LPD3DXTEXTURESHADER)
{
    return 0;
}
...
HRESULT WINAPI Empty_D3DXCreateBuffer (DWORD, LPD3DXBUFFER *)
{
    return 0;
}
...
HRESULT WINAPI Empty_D3DXCreateEffectFromResource (LPDIRECT3DDEVICE9, HMODULE, LPCWSTR, const D3DXMACRO *, LPD3DXINCLUDE, DWORD, LPD3DXEFFECTPOOL, LPD3DXEFFECT *, LPD3DXBUFFER *)
{
    return 0;
}
#else
...
HRESULT WINAPI Empty_D3DXCreateEffectFromResource (LPDIRECT3DDEVICE9, HMODULE, LPCTSTR, const D3DXMACRO *, LPD3DXINCLUDE, DWORD, LPD3DXEFFECTPOOL, LPD3DXEFFECT *, LPD3DXBUFFER *)
{
    return 0;
}
#endif
...
HRESULT WINAPI Empty_D3DXCreateEffectFromFile (LPDIRECT3DDEVICE9, LPCWSTR, const D3DXMACRO *, LPD3DXINCLUDE, DWORD, LPD3DXEFFECTPOOL, LPD3DXEFFECT *, LPD3DXBUFFER *)
{
    return 0;
}
#else
...
HRESULT WINAPI Empty_D3DXCreateEffectFromFile (LPDIRECT3DDEVICE9, LPCTSTR, const D3DXMACRO *, LPD3DXINCLUDE, DWORD, LPD3DXEFFECTPOOL, LPD3DXEFFECT *, LPD3DXBUFFER *)
{
    return 0;
}
#endif
...
HRESULT WINAPI Empty_D3DXLoadSurfaceFromMemory (LPDIRECT3DSURFACE9, const PALETTEENTRY *, const RECT *, LPCVOID, D3DFORMAT, UINT, const PALETTEENTRY *, const RECT *, DWORD, D3DCOLOR)
{
    return 0;
}
...
HRESULT WINAPI Empty_D3DXCompileShaderFromResource (HMODULE, LPCWSTR, const D3DXMACRO *, LPD3DXINCLUDE, LPCSTR, LPCSTR, DWORD, LPD3DXBUFFER *, LPD3DXBUFFER *, LPD3DXCONSTANTTABLE *)
{
    return 0;
}
#else
...
HRESULT WINAPI Empty_D3DXCompileShaderFromResource (HMODULE, LPCTSTR, const D3DXMACRO *, LPD3DXINCLUDE, LPCSTR, LPCSTR, DWORD, LPD3DXBUFFER *, LPD3DXBUFFER *, LPD3DXCONSTANTTABLE *)
{
    return 0;
}
#endif
...
HRESULT WINAPI Empty_D3DXCompileShaderFromFile (LPCWSTR, const D3DXMACRO *, LPD3DXINCLUDE, LPCSTR, LPCSTR, DWORD, LPD3DXBUFFER *, LPD3DXBUFFER *, LPD3DXCONSTANTTABLE *)
{
    return 0;
}
#else
...
HRESULT WINAPI Empty_D3DXCompileShaderFromFile (LPCTSTR, const D3DXMACRO *, LPD3DXINCLUDE, LPCSTR, LPCSTR, DWORD, LPD3DXBUFFER *, LPD3DXBUFFER *, LPD3DXCONSTANTTABLE *)
{
    return 0;
}
#endif
...
HRESULT WINAPI Empty_D3DXCreateTextureShader (const DWORD *, LPD3DXTEXTURESHADER *)
{
    return 0;
}
...
HRESULT WINAPI Empty_D3DXCreateFont (LPDIRECT3DDEVICE9, INT, UINT, UINT, UINT, BOOL, DWORD, DWORD, DWORD, DWORD, LPCWSTR, LPD3DXFONT *)
{
    return 0;
}
#else
HRESULT (WINAPI *_D3DXCreateFont) (LPDIRECT3DDEVICE9, INT, UINT, UINT, UINT, BOOL, DWORD, DWORD, DWORD, DWORD, LPCTSTR, LPD3DXFONT *);
HRESULT WINAPI Empty_D3DXCreateFont (LPDIRECT3DDEVICE9, INT, UINT, UINT, UINT, BOOL, DWORD, DWORD, DWORD, DWORD, LPCTSTR, LPD3DXFONT *)
{
    return 0;
}
#endif
