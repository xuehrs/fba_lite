...
static INT32 __cdecl BurnbprintfFiller(INT32, TCHAR *, ...)
{
    return 0;
}
...
static UINT32 __cdecl BurnHighColFiller(INT32, INT32, INT32, INT32)
{
    return (UINT32)(~0);
}
...
static INT32 __cdecl DefAcb (struct BurnArea * /* pba */)
{
    return 1;
}
...
{
    BurnStateEntry *pNext;
    BurnStateEntry *pPrev;
    char szName[256];
    void *pValue;
    UINT32 nSize;
};
