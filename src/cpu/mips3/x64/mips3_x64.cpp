    ...
    bool mips3_x64::compile_instruction(uint32_t opcode)
    {
        ...
        case 0x00:
        {
            ...
            case 0x3B:
                ...
                break;
            case 0x3C:
                result = DSLL32(opcode);
                break;
            case 0x3E:
                result = DSRL32(opcode);
                break;
            case 0x3F:
                result = DSRA32(opcode);
                break;
...
#else
            case 0x00:
                fallback(opcode, &mips3::SLL);
                break;
            case 0x02:
                fallback(opcode, &mips3::SRL);
                break;
            case 0x03:
                fallback(opcode, &mips3::SRA);
                break;
            case 0x04:
                fallback(opcode, &mips3::SLLV);
                break;
            case 0x06:
                fallback(opcode, &mips3::SRLV);
                break;
            case 0x07:
                fallback(opcode, &mips3::SRAV);
                break;
            case 0x14:
                fallback(opcode, &mips3::DSLLV);
                break;
            case 0x16:
                fallback(opcode, &mips3::DSLRV);
                break;
            case 0x38:
                fallback(opcode, &mips3::DSLL);
                break;
            case 0x3A:
                fallback(opcode, &mips3::DSRL);
                break;
            case 0x3B:
                fallback(opcode, &mips3::DSRA);
                break;
            case 0x3C:
                fallback(opcode, &mips3::DSLL32);
                break;
            case 0x3E:
                fallback(opcode, &mips3::DSRL32);
                break;
            case 0x3F:
                fallback(opcode, &mips3::DSRA32);
                break;

            case 0x10:
                fallback(opcode, &mips3::MFHI);
                break;
            case 0x11:
                fallback(opcode, &mips3::MTHI);
                break;
            case 0x12:
                fallback(opcode, &mips3::MFLO);
                break;
            case 0x13:
                fallback(opcode, &mips3::MTLO);
                break;

            case 0x18:
                fallback(opcode, &mips3::MULT);
                break;
            case 0x19:
                fallback(opcode, &mips3::MULTU);
                break;
            case 0x1A:
                fallback(opcode, &mips3::DIV);
                break;
            case 0x1B:
                fallback(opcode, &mips3::DIVU);
                break;
            case 0x1C:
                fallback(opcode, &mips3::DMULT);
                break;
            case 0x1E:
                fallback(opcode, &mips3::DDIV);
                break;
            case 0x1F:
                fallback(opcode, &mips3::DDIVU);
                break;
            case 0x20:
                fallback(opcode, &mips3::ADD);
                break;
            case 0x21:
                fallback(opcode, &mips3::ADDU);
                break;
            case 0x22:
                fallback(opcode, &mips3::SUB);
                break;
            case 0x23:
                fallback(opcode, &mips3::SUBU);
                break;
            case 0x2D:
                fallback(opcode, &mips3::DADDU);
                break;
            case 0x2F:
                fallback(opcode, &mips3::DSUBU);
                break;

            case 0x24:
                fallback(opcode, &mips3::AND);
                break;
            case 0x25:
                fallback(opcode, &mips3::OR);
                break;
            case 0x26:
                fallback(opcode, &mips3::XOR);
                break;
            case 0x27:
                fallback(opcode, &mips3::NOR);
                break;

            case 0x2A:
                fallback(opcode, &mips3::SLT);
                break;
            case 0x2B:
                fallback(opcode, &mips3::SLTU);
                break;
        ...
        case 0x01:
        {
            ...
            case 0x01:
                ...
                break;
            case 0x10:
                result = BLTZAL(opcode);
                break;
            case 0x11:
                result = BGEZAL(opcode);
                break;
            default:
...
#else
        case 0x08:
            fallback(opcode, &mips3::ADDI);
            break;
        case 0x09:
            fallback(opcode, &mips3::ADDIU);
            break;
        case 0x0A:
            fallback(opcode, &mips3::SLTI);
            break;
        case 0x0B:
            fallback(opcode, &mips3::SLTIU);
            break;
        case 0x0C:
            fallback(opcode, &mips3::ANDI);
            break;
        case 0x0D:
            fallback(opcode, &mips3::ORI);
            break;
        case 0x0E:
            fallback(opcode, &mips3::XORI);
            break;
        case 0x0F:
            fallback(opcode, &mips3::LUI);
            break;
#endif
        case 0x10:
            result = compile_cop0(opcode);
            break;
#if !FULL_FALLBACK
        case 0x11:
            result = compile_cop1(opcode);
            break;
        case 0x18:
            result = DADDI(opcode);
            break;
        case 0x19:
            result = DADDIU(opcode);
            break;
#else
        case 0x11:
            ...
            break;
        case 0x18:
            fallback(opcode, &mips3::DADDI);
            break;
        case 0x19:
            fallback(opcode, &mips3::DADDIU);
            break;
#endif
        ...
        case 0x1A:
            fallback(opcode, &mips3::LDL);
            break;
        case 0x1B:
            fallback(opcode, &mips3::LDR);
            break;

        case 0x2C:
            fallback(opcode, &mips3::SDL);
            break;
        case 0x2D:
            fallback(opcode, &mips3::SDR);
            break;

        case 0x31:
            fallback(opcode, &mips3::LWC1);
            break;
        case 0x39:
            fallback(opcode, &mips3::SWC1);
            break;

#else
        case 0x20:
            fallback(opcode, &mips3::LB);
            break;
        case 0x24:
            fallback(opcode, &mips3::LBU);
            break;
        case 0x21:
            fallback(opcode, &mips3::LH);
            break;
        case 0x25:
            fallback(opcode, &mips3::LHU);
            break;
        case 0x23:
            fallback(opcode, &mips3::LW);
            break;
        case 0x27:
            fallback(opcode, &mips3::LWU);
            break;
        case 0x37:
            fallback(opcode, &mips3::LD);
            break;

        case 0x28:
            fallback(opcode, &mips3::SB);
            break;
        case 0x29:
            fallback(opcode, &mips3::SH);
            break;
        case 0x2B:
            fallback(opcode, &mips3::SW);
            break;
        case 0x3F:
            fallback(opcode, &mips3::SD);
            break;

        case 0x22:
            fallback(opcode, &mips3::LWL);
            break;
        case 0x26:
            fallback(opcode, &mips3::LWR);
            break;
