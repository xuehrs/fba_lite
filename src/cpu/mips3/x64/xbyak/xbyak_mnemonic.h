...
{
    opR_ModM(op, 16 | 32 | 64, 4, 0x0f, 0xba);
    db(imm);
}
...
{
    opR_ModM(op, 16 | 32 | 64, 5, 0x0f, 0xba);
    db(imm);
}
...
{
    opR_ModM(op, 16 | 32 | 64, 6, 0x0f, 0xba);
    db(imm);
}
...
{
    opR_ModM(op, 16 | 32 | 64, 7, 0x0f, 0xba);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x0D, true, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x0C, true, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x41, false, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x40, true, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x42, true, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x0E, true, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x02, true, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x0B, false, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x0A, false, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x44, false, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F | PP_66, 0xC2, true, -1);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F, 0xC2, true, -1);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F | PP_F2, 0xC2, false, -1);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F | PP_F3, 0xC2, false, -1);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x21, false, 0);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x0F, true, -1);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F | PP_66, 0xC6, true, -1);
    db(imm);
}
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F, 0xC6, true, -1);
    db(imm);
}
...
{
    if (!op2.isNone() && !op2.isMEM()) throw Error(ERR_BAD_COMBINATION);
...
{
    if (!(op.isXMM() || op.isMEM())) throw Error(ERR_BAD_COMBINATION);
...
{
    if (!(op.isREG(32) || op.isMEM()) || x.isYMM()) throw Error(ERR_BAD_COMBINATION);
...
{
    opAVX_X_X_XM(x1, x2, op, MM_0F3A | PP_66, 0x4C, false);
    db(x4.getIdx() << 4);
}
void vpblendvb(const Xmm &x1, const Operand &op, const Xmm &x4)
{
    opAVX_X_X_XM(x1, x1, op, MM_0F3A | PP_66, 0x4C, false);
    db(x4.getIdx() << 4);
}
...
{
    if (!op.isNone() && !op.isXMM()) throw Error(ERR_BAD_COMBINATION);
...
{
    if (!r.isBit(i32e)) throw Error(ERR_BAD_COMBINATION);
...
{
    if (!op2.isNone() && !(op2.isREG(i32e) || op2.isMEM())) throw Error(ERR_BAD_COMBINATION);
...
{
    if (x.isYMM()) throw Error(ERR_BAD_COMBINATION);
...
{
    if (!op.isMEM() && !op.isXMM()) throw Error(ERR_BAD_COMBINATION);
    opVex(x, NULL, &op, MM_0F3A | PP_66, 0x1d, 0);
    db(imm);
}
#ifdef XBYAK64
