...
#error "not supported"
    ...
    public:
        struct SReg
        {
            ...
            uint16 idx: 7;
            SReg() : bit(0), idx(0) { }
            void set(const Reg &r)
            {
                this->bit = uint16(r.getBit());
                this->idx = uint16(r.getIdx());
            }
        ...
        const SReg &getBase() const
        {
            return base_;
        }
        const SReg &getIndex() const
        {
            return index_;
        }
        int getScale() const
    ...
    class Address : public Operand
    {
        ...
        void verify() const
        {
            if (isVsib_) throw Error(ERR_BAD_VSIB_ADDRESSING);
        }
    public:
    ...
    public:
        ...
        */
        ...
        {
            if (r.isBit(8)) throw Error(ERR_BAD_SIZE_OF_REGISTER);
