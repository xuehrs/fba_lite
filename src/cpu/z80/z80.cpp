...
OP(xycb, 00)
{
    B = RLC( RM(EA) );    /* RLC  B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 01)
{
    C = RLC( RM(EA) );    /* RLC  C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 02)
{
    D = RLC( RM(EA) );    /* RLC  D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 03)
{
    E = RLC( RM(EA) );    /* RLC  E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 04)
{
    H = RLC( RM(EA) );    /* RLC  H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 05)
{
    L = RLC( RM(EA) );    /* RLC  L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 06)
{
    WM( EA, RLC( RM(EA) ) );							   /* RLC  (XY+o)      */
}
OP(xycb, 07)
{
    A = RLC( RM(EA) );    /* RLC  A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 08)
{
    B = RRC( RM(EA) );    /* RRC  B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 09)
{
    C = RRC( RM(EA) );    /* RRC  C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 0a)
{
    D = RRC( RM(EA) );    /* RRC  D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 0b)
{
    E = RRC( RM(EA) );    /* RRC  E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 0c)
{
    H = RRC( RM(EA) );    /* RRC  H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 0d)
{
    L = RRC( RM(EA) );    /* RRC  L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 0e)
{
    WM( EA, RRC( RM(EA) ) );							   /* RRC  (XY+o)      */
}
OP(xycb, 0f)
{
    A = RRC( RM(EA) );    /* RRC  A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 10)
{
    B = RL( RM(EA) );    /* RL   B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 11)
{
    C = RL( RM(EA) );    /* RL   C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 12)
{
    D = RL( RM(EA) );    /* RL   D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 13)
{
    E = RL( RM(EA) );    /* RL   E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 14)
{
    H = RL( RM(EA) );    /* RL   H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 15)
{
    L = RL( RM(EA) );    /* RL   L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 16)
{
    WM( EA, RL( RM(EA) ) );							   /* RL   (XY+o)      */
}
OP(xycb, 17)
{
    A = RL( RM(EA) );    /* RL   A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 18)
{
    B = RR( RM(EA) );    /* RR   B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 19)
{
    C = RR( RM(EA) );    /* RR   C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 1a)
{
    D = RR( RM(EA) );    /* RR   D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 1b)
{
    E = RR( RM(EA) );    /* RR   E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 1c)
{
    H = RR( RM(EA) );    /* RR   H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 1d)
{
    L = RR( RM(EA) );    /* RR   L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 1e)
{
    WM( EA, RR( RM(EA) ) );							   /* RR   (XY+o)      */
}
OP(xycb, 1f)
{
    A = RR( RM(EA) );    /* RR   A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 20)
{
    B = SLA( RM(EA) );    /* SLA  B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 21)
{
    C = SLA( RM(EA) );    /* SLA  C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 22)
{
    D = SLA( RM(EA) );    /* SLA  D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 23)
{
    E = SLA( RM(EA) );    /* SLA  E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 24)
{
    H = SLA( RM(EA) );    /* SLA  H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 25)
{
    L = SLA( RM(EA) );    /* SLA  L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 26)
{
    WM( EA, SLA( RM(EA) ) );							   /* SLA  (XY+o)      */
}
OP(xycb, 27)
{
    A = SLA( RM(EA) );    /* SLA  A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 28)
{
    B = SRA( RM(EA) );    /* SRA  B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 29)
{
    C = SRA( RM(EA) );    /* SRA  C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 2a)
{
    D = SRA( RM(EA) );    /* SRA  D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 2b)
{
    E = SRA( RM(EA) );    /* SRA  E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 2c)
{
    H = SRA( RM(EA) );    /* SRA  H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 2d)
{
    L = SRA( RM(EA) );    /* SRA  L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 2e)
{
    WM( EA, SRA( RM(EA) ) );							   /* SRA  (XY+o)      */
}
OP(xycb, 2f)
{
    A = SRA( RM(EA) );    /* SRA  A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 30)
{
    B = SLL( RM(EA) );    /* SLL  B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 31)
{
    C = SLL( RM(EA) );    /* SLL  C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 32)
{
    D = SLL( RM(EA) );    /* SLL  D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 33)
{
    E = SLL( RM(EA) );    /* SLL  E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 34)
{
    H = SLL( RM(EA) );    /* SLL  H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 35)
{
    L = SLL( RM(EA) );    /* SLL  L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 36)
{
    WM( EA, SLL( RM(EA) ) );							   /* SLL  (XY+o)      */
}
OP(xycb, 37)
{
    A = SLL( RM(EA) );    /* SLL  A=(XY+o)    */
    WM( EA, A );
}

OP(xycb, 38)
{
    B = SRL( RM(EA) );    /* SRL  B=(XY+o)    */
    WM( EA, B );
}
OP(xycb, 39)
{
    C = SRL( RM(EA) );    /* SRL  C=(XY+o)    */
    WM( EA, C );
}
OP(xycb, 3a)
{
    D = SRL( RM(EA) );    /* SRL  D=(XY+o)    */
    WM( EA, D );
}
OP(xycb, 3b)
{
    E = SRL( RM(EA) );    /* SRL  E=(XY+o)    */
    WM( EA, E );
}
OP(xycb, 3c)
{
    H = SRL( RM(EA) );    /* SRL  H=(XY+o)    */
    WM( EA, H );
}
OP(xycb, 3d)
{
    L = SRL( RM(EA) );    /* SRL  L=(XY+o)    */
    WM( EA, L );
}
OP(xycb, 3e)
{
    WM( EA, SRL( RM(EA) ) );							   /* SRL  (XY+o)      */
}
OP(xycb, 3f)
{
    A = SRL( RM(EA) );    /* SRL  A=(XY+o)    */
    WM( EA, A );
}
...
OP(xycb, 80)
{
    B = RES(0, RM(EA) );    /* RES  0,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, 81)
{
    C = RES(0, RM(EA) );    /* RES  0,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, 82)
{
    D = RES(0, RM(EA) );    /* RES  0,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, 83)
{
    E = RES(0, RM(EA) );    /* RES  0,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, 84)
{
    H = RES(0, RM(EA) );    /* RES  0,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, 85)
{
    L = RES(0, RM(EA) );    /* RES  0,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, 86)
{
    WM( EA, RES(0, RM(EA)) );							   /* RES  0,(XY+o)    */
}
OP(xycb, 87)
{
    A = RES(0, RM(EA) );    /* RES  0,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, 88)
{
    B = RES(1, RM(EA) );    /* RES  1,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, 89)
{
    C = RES(1, RM(EA) );    /* RES  1,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, 8a)
{
    D = RES(1, RM(EA) );    /* RES  1,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, 8b)
{
    E = RES(1, RM(EA) );    /* RES  1,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, 8c)
{
    H = RES(1, RM(EA) );    /* RES  1,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, 8d)
{
    L = RES(1, RM(EA) );    /* RES  1,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, 8e)
{
    WM( EA, RES(1, RM(EA)) );							   /* RES  1,(XY+o)    */
}
OP(xycb, 8f)
{
    A = RES(1, RM(EA) );    /* RES  1,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, 90)
{
    B = RES(2, RM(EA) );    /* RES  2,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, 91)
{
    C = RES(2, RM(EA) );    /* RES  2,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, 92)
{
    D = RES(2, RM(EA) );    /* RES  2,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, 93)
{
    E = RES(2, RM(EA) );    /* RES  2,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, 94)
{
    H = RES(2, RM(EA) );    /* RES  2,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, 95)
{
    L = RES(2, RM(EA) );    /* RES  2,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, 96)
{
    WM( EA, RES(2, RM(EA)) );							   /* RES  2,(XY+o)    */
}
OP(xycb, 97)
{
    A = RES(2, RM(EA) );    /* RES  2,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, 98)
{
    B = RES(3, RM(EA) );    /* RES  3,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, 99)
{
    C = RES(3, RM(EA) );    /* RES  3,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, 9a)
{
    D = RES(3, RM(EA) );    /* RES  3,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, 9b)
{
    E = RES(3, RM(EA) );    /* RES  3,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, 9c)
{
    H = RES(3, RM(EA) );    /* RES  3,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, 9d)
{
    L = RES(3, RM(EA) );    /* RES  3,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, 9e)
{
    WM( EA, RES(3, RM(EA)) );							   /* RES  3,(XY+o)    */
}
OP(xycb, 9f)
{
    A = RES(3, RM(EA) );    /* RES  3,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, a0)
{
    B = RES(4, RM(EA) );    /* RES  4,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, a1)
{
    C = RES(4, RM(EA) );    /* RES  4,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, a2)
{
    D = RES(4, RM(EA) );    /* RES  4,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, a3)
{
    E = RES(4, RM(EA) );    /* RES  4,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, a4)
{
    H = RES(4, RM(EA) );    /* RES  4,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, a5)
{
    L = RES(4, RM(EA) );    /* RES  4,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, a6)
{
    WM( EA, RES(4, RM(EA)) );							   /* RES  4,(XY+o)    */
}
OP(xycb, a7)
{
    A = RES(4, RM(EA) );    /* RES  4,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, a8)
{
    B = RES(5, RM(EA) );    /* RES  5,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, a9)
{
    C = RES(5, RM(EA) );    /* RES  5,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, aa)
{
    D = RES(5, RM(EA) );    /* RES  5,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, ab)
{
    E = RES(5, RM(EA) );    /* RES  5,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, ac)
{
    H = RES(5, RM(EA) );    /* RES  5,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, ad)
{
    L = RES(5, RM(EA) );    /* RES  5,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, ae)
{
    WM( EA, RES(5, RM(EA)) );							   /* RES  5,(XY+o)    */
}
OP(xycb, af)
{
    A = RES(5, RM(EA) );    /* RES  5,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, b0)
{
    B = RES(6, RM(EA) );    /* RES  6,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, b1)
{
    C = RES(6, RM(EA) );    /* RES  6,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, b2)
{
    D = RES(6, RM(EA) );    /* RES  6,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, b3)
{
    E = RES(6, RM(EA) );    /* RES  6,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, b4)
{
    H = RES(6, RM(EA) );    /* RES  6,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, b5)
{
    L = RES(6, RM(EA) );    /* RES  6,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, b6)
{
    WM( EA, RES(6, RM(EA)) );							   /* RES  6,(XY+o)    */
}
OP(xycb, b7)
{
    A = RES(6, RM(EA) );    /* RES  6,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, b8)
{
    B = RES(7, RM(EA) );    /* RES  7,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, b9)
{
    C = RES(7, RM(EA) );    /* RES  7,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, ba)
{
    D = RES(7, RM(EA) );    /* RES  7,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, bb)
{
    E = RES(7, RM(EA) );    /* RES  7,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, bc)
{
    H = RES(7, RM(EA) );    /* RES  7,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, bd)
{
    L = RES(7, RM(EA) );    /* RES  7,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, be)
{
    WM( EA, RES(7, RM(EA)) );							   /* RES  7,(XY+o)    */
}
OP(xycb, bf)
{
    A = RES(7, RM(EA) );    /* RES  7,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, c0)
{
    B = SET(0, RM(EA) );    /* SET  0,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, c1)
{
    C = SET(0, RM(EA) );    /* SET  0,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, c2)
{
    D = SET(0, RM(EA) );    /* SET  0,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, c3)
{
    E = SET(0, RM(EA) );    /* SET  0,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, c4)
{
    H = SET(0, RM(EA) );    /* SET  0,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, c5)
{
    L = SET(0, RM(EA) );    /* SET  0,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, c6)
{
    WM( EA, SET(0, RM(EA)) );							   /* SET  0,(XY+o)    */
}
OP(xycb, c7)
{
    A = SET(0, RM(EA) );    /* SET  0,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, c8)
{
    B = SET(1, RM(EA) );    /* SET  1,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, c9)
{
    C = SET(1, RM(EA) );    /* SET  1,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, ca)
{
    D = SET(1, RM(EA) );    /* SET  1,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, cb)
{
    E = SET(1, RM(EA) );    /* SET  1,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, cc)
{
    H = SET(1, RM(EA) );    /* SET  1,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, cd)
{
    L = SET(1, RM(EA) );    /* SET  1,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, ce)
{
    WM( EA, SET(1, RM(EA)) );							   /* SET  1,(XY+o)    */
}
OP(xycb, cf)
{
    A = SET(1, RM(EA) );    /* SET  1,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, d0)
{
    B = SET(2, RM(EA) );    /* SET  2,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, d1)
{
    C = SET(2, RM(EA) );    /* SET  2,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, d2)
{
    D = SET(2, RM(EA) );    /* SET  2,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, d3)
{
    E = SET(2, RM(EA) );    /* SET  2,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, d4)
{
    H = SET(2, RM(EA) );    /* SET  2,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, d5)
{
    L = SET(2, RM(EA) );    /* SET  2,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, d6)
{
    WM( EA, SET(2, RM(EA)) );							   /* SET  2,(XY+o)    */
}
OP(xycb, d7)
{
    A = SET(2, RM(EA) );    /* SET  2,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, d8)
{
    B = SET(3, RM(EA) );    /* SET  3,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, d9)
{
    C = SET(3, RM(EA) );    /* SET  3,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, da)
{
    D = SET(3, RM(EA) );    /* SET  3,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, db)
{
    E = SET(3, RM(EA) );    /* SET  3,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, dc)
{
    H = SET(3, RM(EA) );    /* SET  3,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, dd)
{
    L = SET(3, RM(EA) );    /* SET  3,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, de)
{
    WM( EA, SET(3, RM(EA)) );							   /* SET  3,(XY+o)    */
}
OP(xycb, df)
{
    A = SET(3, RM(EA) );    /* SET  3,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, e0)
{
    B = SET(4, RM(EA) );    /* SET  4,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, e1)
{
    C = SET(4, RM(EA) );    /* SET  4,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, e2)
{
    D = SET(4, RM(EA) );    /* SET  4,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, e3)
{
    E = SET(4, RM(EA) );    /* SET  4,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, e4)
{
    H = SET(4, RM(EA) );    /* SET  4,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, e5)
{
    L = SET(4, RM(EA) );    /* SET  4,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, e6)
{
    WM( EA, SET(4, RM(EA)) );							   /* SET  4,(XY+o)    */
}
OP(xycb, e7)
{
    A = SET(4, RM(EA) );    /* SET  4,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, e8)
{
    B = SET(5, RM(EA) );    /* SET  5,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, e9)
{
    C = SET(5, RM(EA) );    /* SET  5,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, ea)
{
    D = SET(5, RM(EA) );    /* SET  5,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, eb)
{
    E = SET(5, RM(EA) );    /* SET  5,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, ec)
{
    H = SET(5, RM(EA) );    /* SET  5,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, ed)
{
    L = SET(5, RM(EA) );    /* SET  5,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, ee)
{
    WM( EA, SET(5, RM(EA)) );							   /* SET  5,(XY+o)    */
}
OP(xycb, ef)
{
    A = SET(5, RM(EA) );    /* SET  5,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, f0)
{
    B = SET(6, RM(EA) );    /* SET  6,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, f1)
{
    C = SET(6, RM(EA) );    /* SET  6,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, f2)
{
    D = SET(6, RM(EA) );    /* SET  6,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, f3)
{
    E = SET(6, RM(EA) );    /* SET  6,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, f4)
{
    H = SET(6, RM(EA) );    /* SET  6,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, f5)
{
    L = SET(6, RM(EA) );    /* SET  6,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, f6)
{
    WM( EA, SET(6, RM(EA)) );								   /* SET  6,(XY+o)    */
}
OP(xycb, f7)
{
    A = SET(6, RM(EA) );    /* SET  6,A=(XY+o)  */
    WM( EA, A );
}

OP(xycb, f8)
{
    B = SET(7, RM(EA) );    /* SET  7,B=(XY+o)  */
    WM( EA, B );
}
OP(xycb, f9)
{
    C = SET(7, RM(EA) );    /* SET  7,C=(XY+o)  */
    WM( EA, C );
}
OP(xycb, fa)
{
    D = SET(7, RM(EA) );    /* SET  7,D=(XY+o)  */
    WM( EA, D );
}
OP(xycb, fb)
{
    E = SET(7, RM(EA) );    /* SET  7,E=(XY+o)  */
    WM( EA, E );
}
OP(xycb, fc)
{
    H = SET(7, RM(EA) );    /* SET  7,H=(XY+o)  */
    WM( EA, H );
}
OP(xycb, fd)
{
    L = SET(7, RM(EA) );    /* SET  7,L=(XY+o)  */
    WM( EA, L );
}
OP(xycb, fe)
{
    WM( EA, SET(7, RM(EA)) );							   /* SET  7,(XY+o)    */
}
OP(xycb, ff)
{
    A = SET(7, RM(EA) );    /* SET  7,A=(XY+o)  */
    WM( EA, A );
}
...
OP(op, 34)
{
    WM( HL, INC(RM(HL)) );								   /* INC  (HL)        */
}
OP(op, 35)
{
    WM( HL, DEC(RM(HL)) );								   /* DEC  (HL)        */
}
OP(op, 36)
{
    WM( HL, ARG() );									   /* LD   (HL),n      */
...
OP(op, 37)
{
    F = (F & (SF | ZF | PF)) | CF | (A & (YF | XF));			   /* SCF              */
}

OP(op, 38)
{
    JR_COND( F & CF, 0x38 );							   /* JR   C,o         */
}
OP(op, 39)
{
...
OP(op, 3f)
{
    F = ((F & (SF | ZF | PF | CF)) | ((F & CF) << 4) | (A & (YF | XF)))^CF;	   /* CCF              */
}
...
OP(op, d2)
{
    JP_COND( !(F & CF) );								   /* JP   NC,a        */
}
OP(op, d3)
{
    unsigned n = ARG() | (A << 8);    /* OUT  (n),A       */
    OUT( n, A );
}
OP(op, d4)
{
    CALL_COND( !(F & CF), 0xd4 );						   /* CALL NC,a        */
}
OP(op, d5)
{
    PUSH( de );											   /* PUSH DE          */
...
OP(op, db)
{
    unsigned n = ARG() | (A << 8);    /* IN   A,(n)       */
    A = IN( n );
}
OP(op, dc)
{
    CALL_COND( F & CF, 0xdc );							   /* CALL C,a         */
}
OP(op, dd)
{
    R++;    /* **** DD xx       */
...
void z80_get_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_STR_CORE_CREDITS:
        strcpy(info->s, "Copyright Juergen Buchmueller, all rights reserved.");
        break;
    ...
    case CPUINFO_STR_REGISTER + Z80_PC:
        sprintf(info->s, "PC:%04X", Z80.pc.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_SP:
        sprintf(info->s, "SP:%04X", Z80.sp.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_A:
        sprintf(info->s, "~A:%02X", Z80.af.b.h);
        break;
    case CPUINFO_STR_REGISTER + Z80_B:
        sprintf(info->s, "~B:%02X", Z80.bc.b.h);
        break;
    case CPUINFO_STR_REGISTER + Z80_C:
        sprintf(info->s, "~C:%02X", Z80.bc.b.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_D:
        sprintf(info->s, "~D:%02X", Z80.de.b.h);
        break;
    case CPUINFO_STR_REGISTER + Z80_E:
        sprintf(info->s, "~E:%02X", Z80.de.b.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_H:
        sprintf(info->s, "~H:%02X", Z80.hl.b.h);
        break;
    case CPUINFO_STR_REGISTER + Z80_L:
        sprintf(info->s, "~L:%02X", Z80.hl.b.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_AF:
        sprintf(info->s, "AF:%04X", Z80.af.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_BC:
        sprintf(info->s, "BC:%04X", Z80.bc.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_DE:
        sprintf(info->s, "DE:%04X", Z80.de.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_HL:
        sprintf(info->s, "HL:%04X", Z80.hl.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_IX:
        sprintf(info->s, "IX:%04X", Z80.ix.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_IY:
        sprintf(info->s, "IY:%04X", Z80.iy.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_R:
        sprintf(info->s, "R:%02X", (Z80.r & 0x7f) | (Z80.r2 & 0x80));
        break;
    case CPUINFO_STR_REGISTER + Z80_I:
        sprintf(info->s, "I:%02X", Z80.i);
        break;
    case CPUINFO_STR_REGISTER + Z80_AF2:
        sprintf(info->s, "AF2:%04X", Z80.af2.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_BC2:
        sprintf(info->s, "BC2:%04X", Z80.bc2.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_DE2:
        sprintf(info->s, "DE2:%04X", Z80.de2.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_HL2:
        sprintf(info->s, "HL2:%04X", Z80.hl2.w.l);
        break;
    case CPUINFO_STR_REGISTER + Z80_IM:
        sprintf(info->s, "IM:%X", Z80.im);
        break;
    case CPUINFO_STR_REGISTER + Z80_IFF1:
        sprintf(info->s, "IFF1:%X", Z80.iff1);
        break;
    case CPUINFO_STR_REGISTER + Z80_IFF2:
        sprintf(info->s, "IFF2:%X", Z80.iff2);
        break;
    case CPUINFO_STR_REGISTER + Z80_HALT:
        sprintf(info->s, "HALT:%X", Z80.halt);
        break;
    }
}
