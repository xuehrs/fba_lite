...
static void m6800_set_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_INT_INPUT_STATE + M6800_IRQ_LINE:
        set_irq_line(M6800_IRQ_LINE, info->i);
        break;
    case CPUINFO_INT_INPUT_STATE + M6800_TIN_LINE:
        set_irq_line(M6800_TIN_LINE, info->i);
        break;
    case CPUINFO_INT_INPUT_STATE + M6800_INPUT_LINE_NMI:
    ...
    case CPUINFO_INT_PC:
        ...
        CHANGE_PC();
        break;
    case CPUINFO_INT_REGISTER + M6800_PC:
        m6800.pc.w.l = info->i;
        break;
    case CPUINFO_INT_SP:
        S = info->i;
        break;
    case CPUINFO_INT_REGISTER + M6800_S:
        m6800.s.w.l = info->i;
        break;
    case CPUINFO_INT_REGISTER + M6800_CC:
        m6800.cc = info->i;
        break;
    case CPUINFO_INT_REGISTER + M6800_A:
        m6800.d.b.h = info->i;
        break;
    case CPUINFO_INT_REGISTER + M6800_B:
        m6800.d.b.l = info->i;
        break;
    case CPUINFO_INT_REGISTER + M6800_X:
        m6800.x.w.l = info->i;
        break;
    }
}
...
void m6800_get_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_INT_INPUT_STATE + M6800_IRQ_LINE:
        info->i = m6800.irq_state[M6800_IRQ_LINE];
        break;
    case CPUINFO_INT_INPUT_STATE + M6800_TIN_LINE:
        info->i = m6800.irq_state[M6800_TIN_LINE];
        break;
    case CPUINFO_INT_INPUT_STATE + M6800_INPUT_LINE_NMI:
        info->i = m6800.nmi_state;
        break;

    case CPUINFO_INT_PREVIOUSPC:
        info->i = m6800.ppc.w.l;
        break;
    ...
    case CPUINFO_INT_REGISTER + M6800_X:
        info->i = m6800.x.w.l;
        break;
    case CPUINFO_INT_REGISTER + M6800_WAI_STATE:
        info->i = m6800.wai_state;
        break;

    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_PTR_SET_INFO:
        info->setinfo = m6800_set_info;
        break;
    case CPUINFO_PTR_GET_CONTEXT:
        info->getcontext = m6800_get_context;
        break;
    case CPUINFO_PTR_SET_CONTEXT:
        info->setcontext = m6800_set_context;
        break;
    case CPUINFO_PTR_INIT:
        info->init = m6800_init;
        break;
    case CPUINFO_PTR_RESET:
        info->reset = m6800_reset;
        break;
    case CPUINFO_PTR_EXIT:
        info->exit = m6800_exit;
        break;
    case CPUINFO_PTR_EXECUTE:
        info->execute = m6800_execute;
        break;
    ...
    case CPUINFO_STR_REGISTER + M6800_A:
        sprintf(info->s, "A:%02X", m6800.d.b.h);
        break;
    case CPUINFO_STR_REGISTER + M6800_B:
        sprintf(info->s, "B:%02X", m6800.d.b.l);
        break;
    case CPUINFO_STR_REGISTER + M6800_PC:
        sprintf(info->s, "PC:%04X", m6800.pc.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6800_S:
        sprintf(info->s, "S:%04X", m6800.s.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6800_X:
        sprintf(info->s, "X:%04X", m6800.x.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6800_CC:
        sprintf(info->s, "CC:%02X", m6800.cc);
        break;
    case CPUINFO_STR_REGISTER + M6800_WAI_STATE:
        sprintf(info->s, "WAI:%X", m6800.wai_state);
        break;
    }
}
...
void m6801_get_info(UINT32 state, cpuinfo *info)
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_PTR_INIT:
        info->init = m6801_init;
        break;
    case CPUINFO_PTR_EXECUTE:
        info->execute = m6803_execute;
        break;
#ifdef MAME_DEBUG
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = m6801_dasm;
        break;
#endif /* MAME_DEBUG */
...
void m6802_get_info(UINT32 state, cpuinfo *info)
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_PTR_INIT:
        info->init = m6802_init;
        break;
#ifdef MAME_DEBUG
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = m6802_dasm;
        break;
#endif /* MAME_DEBUG */
...
#ifdef MAME_DEBUG
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = m6803_dasm;
        break;
#endif /* MAME_DEBUG */

    case CPUINFO_PTR_INTERNAL_MEMORY_MAP + ADDRESS_SPACE_PROGRAM:
        info->internal_map = construct_map_m6803_mem;
        break;
...
void m6808_get_info(UINT32 state, cpuinfo *info)
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_PTR_INIT:
        info->init = m6808_init;
        break;
#ifdef MAME_DEBUG
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = m6808_dasm;
        break;
#endif /* MAME_DEBUG */
...
void hd63701_get_info(UINT32 state, cpuinfo *info)
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_PTR_INIT:
        info->init = hd63701_init;
        break;
    case CPUINFO_PTR_EXECUTE:
        info->execute = hd63701_execute;
        break;
#ifdef MAME_DEBUG
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = hd63701_dasm;
        break;
#endif /* MAME_DEBUG */

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case CPUINFO_STR_NAME:
        strcpy(info->s, "HD63701");
        break;
...
void nsc8105_get_info(UINT32 state, cpuinfo *info)
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_PTR_INIT:
        info->init = nsc8105_init;
        break;
    case CPUINFO_PTR_EXECUTE:
        info->execute = nsc8105_execute;
        break;
#ifdef MAME_DEBUG
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = nsc8105_dasm;
        break;
#endif /* MAME_DEBUG */

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case CPUINFO_STR_NAME:
        strcpy(info->s, "NSC8105");
        break;
