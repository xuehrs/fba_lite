...
static UINT16 default_read(UINT32 address)
{
    return ~0;
}
...
static UINT16 IO_read(UINT32 address)
{
    return tms::read_ioreg(&tms34010, address);
}
static void IO_write(UINT32 address, UINT16 value)
{
    tms::write_ioreg(&tms34010, address, value);
}
