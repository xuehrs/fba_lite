...
I8039_INLINE void CLR (UINT8 flag)
{
    R.PSW &= ~flag;
}
I8039_INLINE void SET (UINT8 flag)
{
    R.PSW |= flag;
}
...
static void i8039_set_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_INT_PC:
    case CPUINFO_INT_REGISTER + I8039_PC:
        R.PC.w.l = info->i;
        break;
    case CPUINFO_INT_SP:
    case CPUINFO_INT_REGISTER + I8039_SP:
        R.SP = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_PSW:
        R.PSW = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_A:
        R.A = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_TC:
        R.timer = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_P1:
        R.P1 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_P2:
        R.P2 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R0:
        R0 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R1:
        R1 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R2:
        R2 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R3:
        R3 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R4:
        R4 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R5:
        R5 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R6:
        R6 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_R7:
        R7 = info->i;
        break;
    case CPUINFO_INT_REGISTER + I8039_EA:
        R.EA = info->i;
        break;
    }
}
...
void i8039_get_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_INT_INPUT_STATE + 0:
        info->i = (R.irq_state == I8039_EXTERNAL_INT) ? ASSERT_LINE : CLEAR_LINE;
        break;
    ...
    case CPUINFO_PTR_SET_INFO:
        info->setinfo = i8039_set_info;
        break;
    case CPUINFO_PTR_GET_CONTEXT:
        info->getcontext = i8039_get_context;
        break;
    case CPUINFO_PTR_SET_CONTEXT:
        info->setcontext = i8039_set_context;
        break;
    case CPUINFO_PTR_INIT:
        info->init = i8039_init;
        break;
    case CPUINFO_PTR_RESET:
        info->reset = i8039_reset;
        break;
    case CPUINFO_PTR_EXIT:
        info->exit = i8039_exit;
        break;
    case CPUINFO_PTR_EXECUTE:
        info->execute = i8039_execute;
        break;
    ...
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = i8039_dasm;
        break;
#endif /* ENABLE_DEBUGGER */
    case CPUINFO_PTR_INSTRUCTION_COUNTER:
        info->icount = &i8039_ICount;
        break;
    ...
    case CPUINFO_STR_CORE_CREDITS:
        strcpy(info->s, "Copyright Mirko Buffoni\nBased on the original work Copyright Dan Boris");
        break;
    ...
    case CPUINFO_STR_REGISTER + I8039_PC:
        sprintf(info->s, "PC:%04X", R.PC.w.l);
        break;
    case CPUINFO_STR_REGISTER + I8039_SP:
        sprintf(info->s, "SP:%02X", R.SP);
        break;
    case CPUINFO_STR_REGISTER + I8039_PSW:
        sprintf(info->s, "PSW:%02X", R.PSW);
        break;
    case CPUINFO_STR_REGISTER + I8039_A:
        sprintf(info->s, "A:%02X", R.A);
        break;
    case CPUINFO_STR_REGISTER + I8039_TC:
        sprintf(info->s, "TC:%02X", R.timer);
        break;
    case CPUINFO_STR_REGISTER + I8039_P1:
        sprintf(info->s, "P1:%02X", R.P1);
        break;
    case CPUINFO_STR_REGISTER + I8039_P2:
        sprintf(info->s, "P2:%02X", R.P2);
        break;
    case CPUINFO_STR_REGISTER + I8039_R0:
        sprintf(info->s, "R0:%02X", R.RAM[R.regPtr + 0]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R1:
        sprintf(info->s, "R1:%02X", R.RAM[R.regPtr + 1]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R2:
        sprintf(info->s, "R2:%02X", R.RAM[R.regPtr + 2]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R3:
        sprintf(info->s, "R3:%02X", R.RAM[R.regPtr + 3]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R4:
        sprintf(info->s, "R4:%02X", R.RAM[R.regPtr + 4]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R5:
        sprintf(info->s, "R5:%02X", R.RAM[R.regPtr + 5]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R6:
        sprintf(info->s, "R6:%02X", R.RAM[R.regPtr + 6]);
        break;
    case CPUINFO_STR_REGISTER + I8039_R7:
        sprintf(info->s, "R7:%02X", R.RAM[R.regPtr + 7]);
        break;
    case CPUINFO_STR_REGISTER + I8039_EA:
        sprintf(info->s, "EA:%02X", R.EA);
        break;
    }
}
