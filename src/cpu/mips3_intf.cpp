...
static unsigned char DefReadByte(unsigned int a)
{
    return 0;
}
static unsigned short DefReadHalf(unsigned int a)
{
    return 0;
}
static unsigned int DefReadWord(unsigned int a)
{
    return 0;
}
static unsigned long long DefReadDouble(unsigned int a)
{
    return 0;
}
