...
static void m6809_set_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_INT_INPUT_STATE + M6809_IRQ_LINE:
        set_irq_line(M6809_IRQ_LINE, info->i);
        break;
    case CPUINFO_INT_INPUT_STATE + M6809_FIRQ_LINE:
        set_irq_line(M6809_FIRQ_LINE, info->i);
        break;
    case CPUINFO_INT_INPUT_STATE + M6809_INPUT_LINE_NMI:
        set_irq_line(M6809_INPUT_LINE_NMI, info->i);
        break;
...
void m6809_get_info(UINT32 state, cpuinfo *info)
{
    ...
    case CPUINFO_INT_INPUT_STATE + M6809_IRQ_LINE:
        info->i = m6809.irq_state[M6809_IRQ_LINE];
        break;
    case CPUINFO_INT_INPUT_STATE + M6809_FIRQ_LINE:
        info->i = m6809.irq_state[M6809_FIRQ_LINE];
        break;
    case CPUINFO_INT_INPUT_STATE + M6809_INPUT_LINE_NMI:
        info->i = m6809.nmi_state;
        break;
    ...
    case CPUINFO_PTR_SET_INFO:
        info->setinfo = m6809_set_info;
        break;
    case CPUINFO_PTR_GET_CONTEXT:
        info->getcontext = m6809_get_context;
        break;
    case CPUINFO_PTR_SET_CONTEXT:
        info->setcontext = m6809_set_context;
        break;
    case CPUINFO_PTR_INIT:
        info->init = m6809_init;
        break;
    case CPUINFO_PTR_RESET:
        info->reset = m6809_reset;
        break;
    case CPUINFO_PTR_EXIT:
        info->exit = m6809_exit;
        break;
    case CPUINFO_PTR_EXECUTE:
        info->execute = m6809_execute;
        break;
    case CPUINFO_PTR_BURN:
        info->burn = NULL;
        break;
    case CPUINFO_PTR_DISASSEMBLE:
        info->disassemble = m6809_dasm;
        break;
    case CPUINFO_PTR_INSTRUCTION_COUNTER:
        info->icount = &m6809_ICount;
        break;
    ...
    case CPUINFO_STR_CORE_CREDITS:
        strcpy(info->s, "Copyright John Butler");
        break;
    ...
    case CPUINFO_STR_REGISTER + M6809_PC:
        sprintf(info->s, "PC:%04X", m6809.pc.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6809_S:
        sprintf(info->s, "S:%04X", m6809.s.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6809_CC:
        sprintf(info->s, "CC:%02X", m6809.cc);
        break;
    case CPUINFO_STR_REGISTER + M6809_U:
        sprintf(info->s, "U:%04X", m6809.u.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6809_A:
        sprintf(info->s, "A:%02X", m6809.d.b.h);
        break;
    case CPUINFO_STR_REGISTER + M6809_B:
        sprintf(info->s, "B:%02X", m6809.d.b.l);
        break;
    case CPUINFO_STR_REGISTER + M6809_X:
        sprintf(info->s, "X:%04X", m6809.x.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6809_Y:
        sprintf(info->s, "Y:%04X", m6809.y.w.l);
        break;
    case CPUINFO_STR_REGISTER + M6809_DP:
        sprintf(info->s, "DP:%02X", m6809.dp.b.h);
        break;
    }
}
