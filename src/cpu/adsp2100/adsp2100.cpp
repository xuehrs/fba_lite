...
static CPU_GET_INFO( adsp21xx )
{
    ...
    case CPUINFO_INT_CONTEXT_SIZE:
        info->i = sizeof(adsp2100_state);
        break;
    case CPUINFO_INT_INPUT_LINES:					/* set per CPU */
        break;
    ...
    case CPUINFO_INT_DATABUS_WIDTH_PROGRAM:
        info->i = 32;
        break;
    case CPUINFO_INT_ADDRBUS_WIDTH_PROGRAM:
        info->i = 14;
        break;
    case CPUINFO_INT_ADDRBUS_SHIFT_PROGRAM:
        info->i = -2;
        break;
    case CPUINFO_INT_DATABUS_WIDTH_DATA:
        info->i = 16;
        break;
    case CPUINFO_INT_ADDRBUS_WIDTH_DATA:
        info->i = 14;
        break;
    case CPUINFO_INT_ADDRBUS_SHIFT_DATA:
        info->i = -1;
        break;
    ...
    case CPUINFO_FCT_SET_INFO:
        info->setinfo = CPU_SET_INFO_NAME(adsp21xx);
        break;
    case CPUINFO_FCT_INIT:			/* set per CPU */
        break;
    case CPUINFO_FCT_RESET:
        info->reset = CPU_RESET_NAME(adsp21xx);
        break;
    case CPUINFO_FCT_EXIT:
        info->exit = CPU_EXIT_NAME(adsp21xx);
        break;
    case CPUINFO_FCT_EXECUTE:
        info->execute = CPU_EXECUTE_NAME(adsp21xx);
        break;
    case CPUINFO_FCT_DISASSEMBLE:
        info->disassemble = CPU_DISASSEMBLE_NAME(adsp21xx);
        break;
    case CPUINFO_FCT_IMPORT_STATE:
        info->import_state = CPU_IMPORT_STATE_NAME(adsp21xx);
        break;

    /* --- the following bits of info are returned as pointers --- */
    case CPUINFO_PTR_INSTRUCTION_COUNTER:
        info->icount = &adsp->icount;
        break;
    case CPUINFO_PTR_STATE_TABLE:
        info->state_table = &adsp->state;
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:							/* set per CPU */
        break;
    case DEVINFO_STR_FAMILY:
        strcpy(info->s, "ADSP21xx");
        break;
    ...
    case DEVINFO_STR_CREDITS:
        strcpy(info->s, "Copyright Aaron Giles");
        break;
...
CPU_GET_INFO( adsp2100 )
{
    ...
    case CPUINFO_FCT_INIT:
        info->init = CPU_INIT_NAME(adsp2100);
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:
        strcpy(info->s, "ADSP2100");
        break;
...
CPU_GET_INFO( adsp2101 )
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_FCT_INIT:
        info->init = CPU_INIT_NAME(adsp2101);
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:
        strcpy(info->s, "ADSP2101");
        break;
...
CPU_GET_INFO( adsp2104 )
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_FCT_INIT:
        info->init = CPU_INIT_NAME(adsp2104);
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:
        strcpy(info->s, "ADSP2104");
        break;
...
CPU_GET_INFO( adsp2105 )
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_FCT_INIT:
        info->init = CPU_INIT_NAME(adsp2105);
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:
        strcpy(info->s, "ADSP2105");
        break;
...
CPU_GET_INFO( adsp2115 )
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_FCT_INIT:
        info->init = CPU_INIT_NAME(adsp2115);
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:
        strcpy(info->s, "ADSP2115");
        break;
...
CPU_GET_INFO( adsp2181 )
{
    ...
    /* --- the following bits of info are returned as pointers to data or functions --- */
    case CPUINFO_FCT_INIT:
        info->init = CPU_INIT_NAME(adsp2181);
        break;

    /* --- the following bits of info are returned as NULL-terminated strings --- */
    case DEVINFO_STR_NAME:
        strcpy(info->s, "ADSP2181");
        break;
